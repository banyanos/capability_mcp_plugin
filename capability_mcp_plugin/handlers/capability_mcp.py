...
from mcp_protocol_plugin.handlers.mcp_external import sync_external_mcp_server
from mcp_protocol_plugin.handlers.mcp_git import (
    install_mcp_package_from_git,
)
from mcp_protocol_plugin.handlers.mcp_handlers import (
    process_base64_package,
    process_mcp_package,
)
from silvaengine_daemon.repositories import get_repo
...
def store_capability_metadata(
    ...
    try:
        ...
        from mcp_protocol_plugin.handlers.config import _dispatch_internal_graphql
